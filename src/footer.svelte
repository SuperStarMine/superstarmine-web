    ...
    section
      ...
      @media screen and (orientation: landscape)
        ...
        &:after
          ...
          left 0
          bottom 0
          background linear-gradient(to right, #ff0200, #ff5a23, #f7931d)
